...
You can find the complete source code here: [https://github.com/eunomia-bpf/bpf-developer-tutorial/tree/main/src/30-mysslaudit](https://github.com/eunomia-bpf/bpf-developer-tutorial/tree/main/src/30-mysslaudit)

## Compilation and Execution

To start using `mysslaudit`, you need to first compile it:
...
In a terminal, execute the following command to start `mysslaudit`:
...
After executing the `curl` command, `mysslaudit` will display the following content:
...
- <https://github.com/iovisor/bcc/blob/master/tools/mysslaudit_example.txt>
- <https://en.wikipedia.org/wiki/Transport_Layer_Security>

> The original link of this article: <https://eunomia.dev/tutorials/30-mysslaudit>
